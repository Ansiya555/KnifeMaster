...
public class AnalyticsExampleSecondaryScreen : MonoBehaviour
{
    void OnGUI()
    {
        ...
        {
            Analytics.gua.sendEventHit("OpenWebsite", "Strobotnik.com",null,-1);
        ...
        {
            Analytics.gua.sendEventHit("OpenWebsite", "bitly.com/DynTextUnity",null,-1);
            Application.OpenURL("http://bitly.com/DynTextUnity");
        }
        if (GUILayout.Button("Internet\nReachability\nVerifier"))
        {
            Analytics.gua.sendEventHit("OpenWebsite", "j.mp/IRVUNAS", null, -1);
            Application.OpenURL("http://j.mp/IRVUNAS");
        }
        if (GUILayout.Button("Klattersynth\nTTS"))
        {
            Analytics.gua.sendEventHit("OpenWebsite", "j.mp/KLTTR", null, -1);
